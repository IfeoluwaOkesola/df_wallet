...
export class Migrations1742847326918 implements MigrationInterface {
    name = 'Migrations1742847326918'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "users" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "email" character varying NOT NULL, "password" character varying NOT NULL, "firstName" character varying, "lastName" character varying, "address" character varying, "phoneNumber" character varying, "stateLgaId" integer, "profilePicture" character varying, "tier" integer NOT NULL DEFAULT '1', "pin" character varying, "otp" character varying, "password_reset_token" character varying, "token_expires_at" TIMESTAMP, "isValidated" boolean NOT NULL DEFAULT false, "isActive" boolean NOT NULL DEFAULT false, "isEnabled" boolean NOT NULL DEFAULT false, "isDeleted" boolean NOT NULL DEFAULT false, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "lastUpdatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, CONSTRAINT "UQ_c0d176bcc1665dc7cb60482c817" UNIQUE ("password_reset_token"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
